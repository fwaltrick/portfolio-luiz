      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-end items-center">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center py-1.5 px-3 border border-gray-300 hover:border-gray-400 text-sm text-gray-700 rounded-lg transition-colors duration-200 font-light bg-white cursor-pointer"
        ...
        <motion.div
          ...
          animate={{ height: filterHeight, marginTop: isFilterOpen ? 12 : 0 }}
          transition={{
            duration: 0.3,
            ...
            >
              {categories.map((category) => (
                <button
                  ...
                  className={`text-sm rounded-md transition-colors duration-200 font-light flex items-center ${
